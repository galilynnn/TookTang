...
def show_info_page():
    ...
    st.markdown("""
    TookTang เป็นแอปพลิเคชันที่ใช้ปัญญาประดิษฐ์ช่วยในการแยกขยะอย่างถูกต้อง 
    เพื่อส่งเสริมการจัดการขยะที่มีประสิทธิภาพและเป็นมิตรกับสิ่งแวดล้อม
    """)
